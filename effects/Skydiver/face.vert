...
void main()
{
	...
	const float cdelta = 5.;

	const float sOfssetXneg = -cdelta * dx;
	const float sOffsetYneg = -cdelta * dy;
	const float sOffsetXpos = cdelta * dx;
	const float sOffsetYpos = cdelta * dy;
