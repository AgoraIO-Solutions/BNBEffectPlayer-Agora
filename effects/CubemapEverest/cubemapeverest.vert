...
#ifdef GLFX_LIGHTING
    var_n = quat_rotate( glfx_VIEW_QUAT, mat3(glfx_MV)*(attrib_n*mat3(m)) );
#ifdef GLFX_TBN
    var_t = quat_rotate( glfx_VIEW_QUAT, mat3(glfx_MV)*(attrib_t.xyz*mat3(m)) );
    var_b = quat_rotate( glfx_VIEW_QUAT, attrib_t.w*cross( var_n, var_t ) );
#endif
    var_v = quat_rotate( glfx_VIEW_QUAT, (glfx_MV*vec4(vpos,1.)).xyz );
#endif
